...
export const Home = () => {
    ...
    return <div className="text-center items-center flex flex-col bg-slate-50 text-slate-700 min-h-[100vh]">
        <div className={`my-[15vh] text-6xl font-semibold bg-${language} text-slate-100 p-8 rounded-3xl transition-colors duration-500`}>
        ...
        <div className="flex gap-6 mb-24">
            ...
            <Select value={language} onValueChange={value => setLanguage(value)} >
                ...
                <SelectContent className="w-[200px] border-4 rounded-xl border-slate-200 border-opacity-90  bg-slate-50 m-0 p-0">
            ...
            <Link to={`/${language}/analysis`}>
                <Button className={`bg-${language} hover:bg-${language}Selected w-[200px] h-[60px] shadow-xl rounded-xl transition-colors duration-500`}>
